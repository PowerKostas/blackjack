...
{	
	...
	// Epishs pairnoun diaforetikes times apo autes pou etyxan (px h karta J tha exei aksia 10 kai oxi 11 opws tha tyxaine)
	if (random_num==13)
	{
		card.value=10;
	...
	else 
	{
		...
		// Metatrepei ton tyxaio int se char gia na mpei st� ypoloipo string pou tha ektypwthei
